...
export const updateArticle = async(req,res)=>{
    try{
        ...
        res.status(404).send({ status: "error", message: "Trying to update an article which doesn't exist" });
    }
}
...
export const deleteArticle = async(req,res)=>{
    try{
        ...
        return res.status(200).send({ status: "success", message: "Article delete successfully" });
    }catch(err){
        res.status(404).send({ status:"error", message: "Trying to delete an article that doesn't exist!"});
    }
}
...
export const comment = async(req,res)=>{
    try{
        ...
        await article.save();
        return res.status(200).send({ status: "success", data: article });
    }catch(err){
        return res.status(404).send({ status:"error", message: "Trying to comment on an article that doesn't exist!"});
    }
}
...
export const like = async(req,res)=>{
    try{
        ...
        return res.status(404).send({ status:"error", message: "Trying to like an article that doesn't exist!"});
    }
}